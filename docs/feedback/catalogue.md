...
Built from `908d2ad`. 101 parts across 14 screens, holding 579 of the table's 582 copy keys; 3 have no surface and are excused by name at the foot.

## intro (1)

### `intro.sequence`

Intro sequence. The caveat slides, and the tl;dr acknowledgement modal that gates the end of the sequence.
