  ...
  days: [
    {
      ...
      pushups: false,
      exercises: [
        { name: "Barbell bench press",     sets: "2→4", reps: "6–8",   note: "Start at 65 kg", video: "bench press perfect form jeff nippard" },
        { name: "Overhead press (barbell)", sets: "2→4", reps: "8–10", video: "overhead press standing barbell form athlean" },
        { name: "Incline DB press",         sets: "2→3", reps: "10–12", video: "incline dumbbell press form jeff nippard" },
        { name: "Lateral raises",           sets: "2→3", reps: "12–15", video: "lateral raises perfect form jeff nippard" },
        { name: "Tricep overhead extension",sets: "2→3", reps: "12", video: "overhead tricep extension long head form" },
      ],
    },
    {
      n: 2,
      ...
      pushups: true,
      exercises: [
        { name: "Pull-ups (or lat pulldown)",sets: "2→4", reps: "max", video: "perfect pullup form jeff nippard" },
        { name: "Barbell row (Pendlay)",    sets: "2→4", reps: "6–8", video: "pendlay row form technique" },
        { name: "DB single-arm row",        sets: "2→3", reps: "10–12", video: "single arm dumbbell row form meadows" },
        { name: "Face pulls",               sets: "3",   reps: "15–20", note: "Mandatory — every Pull day, forever", video: "face pulls athlean rear delt form" },
        { name: "Barbell bicep curl",       sets: "2→3", reps: "10–12", video: "barbell bicep curl form jeff nippard" },
        { name: "Hammer curl",              sets: "2",   reps: "12", video: "hammer curl brachialis form" },
      ],
    },
    {
      n: 3,
      ...
      pushups: true,
      exercises: [
        { name: "Barbell back squat",        sets: "2→4", reps: "6–8",   note: "60% of previous max", video: "back squat form squat university" },
        { name: "Romanian deadlift",         sets: "2→3", reps: "10–12", video: "romanian deadlift form jeff nippard" },
        { name: "Leg press → Bulgarian split", sets: "2→3", reps: "10–12", note: "Bulgarian from wk 5", video: "bulgarian split squat form jeff nippard" },
        { name: "Leg curl (machine)",        sets: "2→3", reps: "12–15", video: "lying leg curl form hamstring" },
        { name: "Calf raise",                sets: "3→4", reps: "15–20", video: "calf raise form jeff nippard" },
      ],
    },
    {
      n: 4,
      ...
      pushups: true,
      exercises: [
        { name: "Push-ups (3 × max)", sets: "3", reps: "max", note: "Daily push-up sets only", video: "perfect pushup form athlean" },
    ...
    },
    {
      ...
      pushups: false,
      exercises: [
        { name: "Trap bar DL → conventional", sets: "4", reps: "4–5", note: "Conventional from wk 9. Always first.", video: "trap bar deadlift vs conventional biomechanics" },
        { name: "Weighted pull-ups",         sets: "3", reps: "6–8", video: "weighted pullup form progression" },
        { name: "Close-grip bench press",    sets: "3", reps: "6–8", video: "close grip bench press tricep form" },
        { name: "Barbell row (heavier)",     sets: "3", reps: "5–6", video: "barbell row form heavy science" },
        { name: "Push press",                sets: "3", reps: "6", video: "push press form technique jeff nippard" },
      ],
    },
    {
      n: 6,
      ...
      pushups: true,
      exercises: [
        { name: "Rower intervals", sets: "—", reps: "20 min", note: "1 min hard / 2 min easy", video: "rowing machine perfect form technique drive" },
        { name: "Stair climber",   sets: "—", reps: "20 min", note: "Steady moderate" },
        { name: "Plank",           sets: "3", reps: "60 s", video: "plank perfect form athlean" },
        { name: "Ab wheel rollout",sets: "3", reps: "10", video: "ab wheel rollout form athlean" },
        { name: "Hanging knee raise", sets: "3", reps: "12–15", video: "hanging knee raise form abs" },
      ],
    },
    {
      n: 7,
