...
// no source handed down for it. `INTRO_DISCLAIMER` is the disclaimer the owner wrote for the
// one-time intro sequence; this file reads that named constant character for character so the sentence stays reachable
...
import { INTRO_DISCLAIMER } from '../../content/introSlides';
...
/** Shared with IntroSequence via INTRO_DISCLAIMER; never duplicate the owner's wording here. */
const DISCLAIMER = INTRO_DISCLAIMER;
